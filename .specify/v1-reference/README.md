...
| [TRADE_EXECUTION.md](./TRADE_EXECUTION.md) | PayLightningInvoice, AddLightningInvoice, TradeDetail, acciones `pay-invoice`/`fiat-sent`/`release` | UI en Flutter, lógica de estado en Rust |
