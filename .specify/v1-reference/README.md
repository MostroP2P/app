...
| [MOSTRO_SERVICE.md](./MOSTRO_SERVICE.md) | Mostro protocol communication (gift wrap, message routing, order publishing) | Move core logic to Rust (flutter_rust_bridge 2.x); Flutter handles UI integration |
| [EXCHANGE_SERVICE.md](./EXCHANGE_SERVICE.md) | Bitcoin/fiat exchange rate fetching (abstract service + Yadio implementation) | Keep in Flutter (HTTP API integration); use flutter_rust_bridge 2.x where applicable |
| [ENCRYPTION_SERVICE.md](./ENCRYPTION_SERVICE.md) | ChaCha20-Poly1305 AEAD encryption for local storage and P2P messaging | Move to Rust (crypto should be platform-agnostic; flutter_rust_bridge 2.x) |
