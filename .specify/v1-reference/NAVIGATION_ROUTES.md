...
| `/dispute_details/:disputeId` | `DisputeChatScreen` | `dispute_chat_screen.dart` | Chat de disputa (ver `DISPUTE_SYSTEM.md`) |
| `/rate_user/:orderId` | `RateCounterpartScreen` | `rate_counterpart_screen.dart` | Post-trade rating (ver `RATING_SYSTEM.md`) |
