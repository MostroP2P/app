...
// These functions are ignored because they are not marked as `pub`: `_run_order_subscription`, `abandon_maker_bond`, `admin_pubkey_from_payload`, `adopt_range_remainder`, `advance_claim_phase`, `apply_ingested_order`, `apply_local_cancel`, `apply_payout_completed`, `apply_payout_request`, `apply_peer_reveal`, `apply_single_order_update`, `apply_upsert`, `bond_cancel_reason`, `bond_deadline`, `bond_expired`, `bond_refresh_is_stale`, `bond_requested`, `build_trade_key_map`, `claim_single_order_task`, `close_expired_bond_trade`, `confirm_maker_bond`, `confirm_payout_completion`, `current_local_status`, `dispatch_mostro_message`, `dispute_id_from_payload`, `emit_trade_update_at`, `emit_trade_update_with`, `emit_trade_update`, `ensure_global_dm_coverage`, `fetch_public_order_status`, `fetch_public_order`, `fill_restored_maker_row`, `forget_trade_key_miss`, `forget_wire_order`, `get_trade_key_index`, `global_dm_keys`, `handle_create_bond_reply`, `handle_global_daemon_message`, `handle_single_order_event`, `ingest_order_event_with`, `ingest_order_event`, `is_claim_action`, `is_duplicate_daemon_message`, `is_matching_cant_do_refusal`, `is_matching_last_trade_index_reply`, `is_restored_maker_placeholder`, `last_trade_index`, `load_status_cursor`, `local_trade_status`, `lock_maker_bond`, `lock_order`, `log_wire_status_sync`, `lookup_trade_key_index`, `maker_order_is_published`, `maybe_capture_peer_reveal`, `mostro_dm_subscription_id`, `newest_book_order`, `newest_book_status`, `next_trade_for_range_remainder`, `note_bond_locked`, `note_bond_released`, `note_trade_key_miss`, `note_user_cancel`, `note_wire_order`, `order_book_filters`, `order_book`, `order_locks`, `orders_subscription_id`, `peer_reveal_pubkeys`, `persist_bond`, `persist_confirmed_take`, `persist_late_create_confirmation`, `persist_peer_reputation`, `persist_restored_bond_rows`, `persist_trade_row`, `process_order_event`, `publish_event_json`, `publish_event`, `publish_on_stored_events_end`, `publish`, `rebuild_trade_from_dm`, `recent_orders_subscription_id`, `record_miss`, `record_status_event`, `record`, `recovered_max_trade_index`, `refetch_active_node_orders`, `refresh_subscriptions_for_active_node`, `refresh_wire_order`, `relay_list_subscription_id`, `release_single_order_task`, `remove_order_deferred`, `replace_global_dm_filter`, `replace_subscription`, `resolve_add_invoice_destination`, `resolve_dm_recipient`, `resolve_peer_side`, `restored_bond_row`, `resubscribe_global_dm_filter`, `resync_floor`, `resync_republished_maker_order`, `run_stale_sweep_once`, `sanitize_trade_index`, `schedule_publish`, `seed_global_dm_coverage`, `settle_after_lost_take`, `single_order_subscription_id`, `single_order_task_is_current`, `single_order_tasks`, `spawn_stale_sweep`, `status_arm_gate`, `status_sync_blocked_by_terminal`, `status_write_blocked`, `store_trade_key_index`, `subscribe_accepted`, `subscribe_daemon_messages`, `subscribe_node_filters`, `subscribe_single_order`, `subscribe`, `sweep_action`, `sync_trade_fields_if_changed`, `take_user_cancel`, `tombstone_covers`, `trade_key_for_order`, `trade_key_index_of`, `trade_key_map`, `trade_key_misses`, `trade_row_from_small_order`, `trade_row_state`, `trade_updates_tx`, `trade`, `upsert_order_coalesced`, `upsert_order_deferred`, `user_cancels`, `waiting_bond_status`, `wipe_never_active_trade`, `wipe_on_public_cancel`, `wipe_trade_row`, `wire_notes`, `with_bond_window`
// These types are ignored because they are neither used by any `pub` functions nor (for structs and enums) marked `#[frb(unignore)]`: `DedupWindow`, `Publish`, `ResetGuard`, `RowState`, `SingleOrderEvent`, `SweepAction`
// These function are ignored because they are on traits that is not defined in current crate (put an empty `#[frb]` on it to unignore): `assert_fields_are_eq`, `clone`, `clone`, `drop`, `eq`, `eq`, `eq`, `fmt`, `fmt`, `fmt`
